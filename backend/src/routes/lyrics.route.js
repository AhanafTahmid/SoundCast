...
// routes/lyrics.route.js
import express from "express";
import { generateLyrics, getAllLyrics } from "../controller/lyric.controller.js";

const router = express.Router();

// POST /api/lyrics → generate and save lyrics
router.post("/", generateLyrics);

// GET /api/lyrics → get all saved lyrics
