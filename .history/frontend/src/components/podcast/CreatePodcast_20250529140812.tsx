...
const CreatePodcast = () => {
  ...
  const handleSubmit = async (e: React.FormEvent | React.MouseEvent) => {
    ...
    formData.append("audioUrl", aiAudioUrl);
    formData.append("thumbnailUrl", aiThumbnailUrl!);

    // formData.append("audioUrl", "https://res.cloudinary.com/dqws4dc51/video/upload/v1748503500/iaax4brdq4krr3ehib4f.wav");
    // formData.append("thumbnailUrl", "https://res.cloudinary.com/dqws4dc51/image/upload/v1748503501/rcypcyzri57bbgmcg9j3.png");
    // formData.append("audioUrl", aiAudioUrl, "podcast-audio.mp3");
    // formData.append("thumbnailUrl", aiThumbnailUrl, "podcast-thumbnail.png");
