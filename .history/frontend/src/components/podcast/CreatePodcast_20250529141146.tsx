...
const CreatePodcast = () => {
  ...
  const handleSubmit = async (e: React.FormEvent | React.MouseEvent) => {
    ...
    // --- AUDIO FILE ---
    // Always fetch the audio as a blob from aiAudioUrl and append as audioFile
    if (aiAudioUrl) {
    ...
    // --- IMAGE FILE ---
    // Use customImage if present, else fetch blob from aiThumbnailUrl
    if (customImage) {
      formData.append("imageFile", customImage, customImage.name);
    } else if (aiThumbnailUrl) {
